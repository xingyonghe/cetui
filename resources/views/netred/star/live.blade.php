    ...
    <div class="container marTB_15">
        <div class="width_1140">
            <div class="c_route">
                ...
                @if(isset($info))
                    <a href="{{ route('netred.star.edit',[$info['id']]) }}"><span class="on">修改直播账户</span></a>
                @else
                    <a href="{{ route('netred.star.live') }}"><span class="on">添加直播账户</span></a>
                @endif
                ...
                <form role="form" class="data-form" action="{{ route('netred.star.update') }}" method="post">
                    ...
                    <div class="c_tggl_box">
                        ...
                        <div class="c_tggl_line">
                            ...
                            <div class="c_tggl_right">
                                <input type="text" name="max_num" placeholder="请填写最高观看人数"  id="max_num" @if(isset($info['max_num'])) value="{{ $info['max_num'] }}" @endif  class="width_424">
                            </div>
                        </div>
                        <div class="c_tggl_line">
                            <div class="c_tggl_left">
                            ...
                            <div class="c_tggl_right">
                                <input type="text" name="average_num" placeholder="请填写平均在线观看人数"  id="average_num" @if(isset($info['average_num'])) value="{{ $info['max_num'] }}" @endif  class="width_424">
                            </div>
                        </div>
                        <div class="c_tggl_line">
                            <div class="c_tggl_left">
