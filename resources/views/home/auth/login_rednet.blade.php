                ...
                <div class="shuru">
                    <div class="main_nav">
                        <ul>
                            ...
                            <li><a class="cd-signup" href="{{ route('home.register.rednet') }}">网红注册</a></li>
                        </ul>
                    </div>
                    <div class="biaodan">
                        <div class="denglu">
                            <form class="form-horizontal data-form" method="POST" action="{{ route('home.login.post') }}" autocomplete="off">
                                {{ csrf_field() }}
