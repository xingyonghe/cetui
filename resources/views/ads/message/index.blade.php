    ...
    <div class="container marTB_15">
        <div class="width_1140">
            <div class="c_route">
                ...
                <a href="{{ route('ads.message.index') }}"><span class="on">信息中心</span></a>
            </div>
            <div class="c_box">
                <div class="c_box3">
                        ...
                        @if($lists->total())
                            @foreach($lists as $key=>$item)
                                <tr>
                                    ...
                                    <td style="text-align: left; padding-left: 50px;"><a href="{{ route('ads.message.show',[$item['id']]) }}"  title="点击查看详情" alt="点击查看详情">{{ $item['title'] }}</a></td>
