...
class MessageController  extends Controller
{
    ...
    public function index()
    {
        ...
        SEO::setTitle('消息中心-广告主中心'.configs('WEB_SITE_TITLE'));
        return view('ads.message.index',compact('lists'));
    }
    ...
    public function show(int $id)
    {
        ...
        SEO::setTitle('消息详情-广告主中心'.configs('WEB_SITE_TITLE'));
        return view('ads.message.show',compact('info'));
    }
